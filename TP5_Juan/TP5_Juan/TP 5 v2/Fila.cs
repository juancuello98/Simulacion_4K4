...
namespace TP_5_v2
{
    class Fila
    {
        ...
        public void proximaLlegadaPedido(Random random)
        {
            int n = 0;
        ...
        public void generarTipoDePedido(double rnd)
        {
            ...
            {
                this.tipoPedidoPedido = "Hamburguesa";
            }
        }

        public double GenerartiempoPreparacion(double rnd, string tipo, bool calculoEuler)
        {
            double time;
            switch (tipo)
            {
                case "Pizza":
                    time = calcularTiempoParaLaPizza(rnd, calculoEuler);                     
                    break;
                case "Sandwich":
        ...
        public double calcularTiempoParaLaPizza(double rnd, bool calculoConEuler)
        {
            double time = 0;
            if (calculoConEuler == true)
            {
                //realizarCalculoConEuler();
            }
            else
            {
